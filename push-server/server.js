// ============================================
// CIVILCALC — Push Notification Server
...
const VAPID_SUBJECT = process.env.VAPID_SUBJECT || 'mailto:admin@civilcalc.app';
...
cron.schedule('0 9 * * 1-5', async () => {
    ...
    const payload = JSON.stringify({
        title: '🏗️ CivilCalc',
        body: '¡Arrancá el día con tus cálculos al día!',
        icon: '/icon-192.svg',
        data: { url: '/' }
    });
...
app.listen(PORT, () => {
    console.log(`\n🏗️ CivilCalc Push Server running on http://localhost:${PORT}`);
